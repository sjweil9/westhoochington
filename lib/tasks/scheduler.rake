...
EMAIL_SLEEPER_MAPPING = {
  ...
  "austinlayton6@gmail.com" => "995925911360937984",
}

SLEEPER_LEAGUE_IDS = {
  "2021" => %w[737785373232623616 737553262500306944 735284283123548160],
  "2022" => %w[868660188851396608 868727573214081024 868920879285960704 868978011544952832 863898953769484288],
  "2023" => %w[986720117125910528 995551758896218112 995585749057732608 995762959395725312 995925343447965696 996182546088083456],
  "2024" => %w[1136015046422994944 1135770505807990784],
  "2025" => %w[1262564960089669632 1264718342334185472 1266121532665495552]
}
...
namespace :sleeper do
  ...
  task :update_leagues, [:season_year] => :environment do |_t, args|
    ...
    SLEEPER_LEAGUE_IDS[season_year].each do |league_id|
      Sleeper::UpdateResultsJob.perform_now(league_id)
    end
  end
